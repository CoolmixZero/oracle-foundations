...
**Вторая нормальная форма (2NF) требует, чтобы таблица имела следующие два свойства: <br />
Быть в 1NF: Таблица должна быть в первой нормальной форме (1NF), что означает, что каждая ячейка в таблице должна содержать только атомарные значения, а каждый столбец должен иметь уникальное имя. <br />
